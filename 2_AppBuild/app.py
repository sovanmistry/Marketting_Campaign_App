...
## Load necessary key info from .env
...
def getLLMResponse(query, age_option, tasktype_option):        
    ...
    new_prompt_template = FewShotPromptTemplate(
        ...
        prefix=prefix,
        suffix=suffix,
        input_variables=["template_userInput", "template_tasktype_option", "template_age_option"],
        example_separator="\n\n"
    )


    query = form_input
    print(new_prompt_template.format(template_userInput = query, template_tasktype_option = tasktype_option, template_age_option = age_option))


    response = llm(new_prompt_template.format(template_userInput = query, template_tasktype_option = tasktype_option, template_age_option = age_option))
    print(response)
...
form_input = st.text_area('Enter text', height=175)
